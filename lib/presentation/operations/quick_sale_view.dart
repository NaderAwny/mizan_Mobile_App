...
class QuickSaleView extends StatelessWidget {
  ...
  const QuickSaleView({super.key, this.args});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<TransactionFormCubit>(
      ...
      child: _QuickSaleScreen(args: effectiveArgs),
    );
  }
}

class _QuickSaleScreen extends StatefulWidget {
  final QuickTransactionArgs? args;

  const _QuickSaleScreen({this.args});

  @override
  State<_QuickSaleScreen> createState() => _QuickSaleScreenState();
}

class _CustomInstallmentEntry {
...
class _QuickSaleScreenState extends State<_QuickSaleScreen> {
  ...
  final List<num> _quickAmountChips = [50, 100, 250, 500, 1000];
    ...
    return SingleChildScrollView(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            // ── 1. Amount Input Hero (Figma Node #2025:83) ──────────────
            _buildAmountSection(),

            SizedBox(height: 14.h),

            // ── 2. Quick Amount Chips (Figma Node #2025:86) ─────────────
            _buildQuickAmountChips(),

            SizedBox(height: 20.h),

            // ── 3. Customer Picker (Figma Node #2025:97) ────────────────
            _buildCustomerField(),

            SizedBox(height: 16.h),

            // ── 4. Date & Payment Method Row (Figma Node #2025:107) ──────
            _buildDateAndPaymentRow(),

            SizedBox(height: 16.h),

            // ── 5. Installment Switch Row (Figma Node #2025:120) ─────────
            _buildInstallmentSwitchCard(),

            // ── 6. Expanded Installment Configuration (Cases 4.3 & 4.6) ──
            if (_isInstallment) ...[
              SizedBox(height: 14.h),
            ...
            // ── 8. Action Button (Figma Node #2025:124) ──────────────────
              ...
              children: [
                ...
                Expanded(
                  child: hasSelection
                      ...
                      : Text(
                          "اختر العميل من الدليل أو اكتب اسمه...",
          ...
          Switch(
            ...
            onChanged: (val) {
              setState(() {
                _isInstallment = val;
                if (val && _isCash) {
                  _isCash = false; // Installments imply credit payment
                }
              });
            },
          ),
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          maxLines: 2,
          decoration: InputDecoration(
            hintText: "أضف أي تفاصيل أو أرقام فواتير أو شروط إضافية...",
